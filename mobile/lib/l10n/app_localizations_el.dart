...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get tabRoute => 'Διαδρομή';

  @override
  String get tabWeather => 'Καιρός';

  @override
  String get tabMooring => 'Αγκυροβόλιο';

  @override
  String get tabMore => 'Περισσότερα';
  ...
  @override
  String get localeEnglish => 'Αγγλικά';

  @override
  String get localeRussian => 'Ρωσικά';

  @override
  String get localeGerman => 'Γερμανικά';

  @override
  String get localeFrench => 'Γαλλικά';

  @override
  String get localeSpanish => 'Ισπανικά';

  @override
  String get localeItalian => 'Ιταλικά';
  ...
  @override
  String get mapLayersSheetTitle => 'Επίπεδα χάρτη';
  ...
  @override
  String get mapLayerWindParticles => 'Σωματίδια ανέμου';

  @override
  String get mapLayerWindParticlesSubtitle =>
      'Κινούμενο πεδίο ροής (παύση σε eco / μείωση κίνησης)';
  ...
  @override
  String get weatherScreenTitle => 'Καιρός';
  ...
  @override
  String get moreMenuHeadline => 'Ασφάλεια, ημερολόγιο & πλήρωμα';
  ...
  @override
  String get moreMenuCommunity => 'Κοινότητα';
  ...
  @override
  String get communityHubTitle => 'Κοινότητα';
  ...
  @override
  String get voyageMonitorTitle => 'Παρακολούθηση ταξιδιού';
  ...
  @override
  String get yachtHubTitle => 'Κέντρο σκάφους';
  ...
  @override
  String get assistantTitle => 'Βοηθός καταστρώματος';
  ...
  String get errorNetwork =>
      'Το δίκτυο δεν είναι διαθέσιμο — ελέγξτε τη σύνδεση και δοκιμάστε ξανά.';
